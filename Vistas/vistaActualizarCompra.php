...
<div class="container-fluid" id="containerFila">
            <div class=".container-fluid d-flex flex-wrap justify-content-between" >
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control needs-validation" id="IdProducto" name="Producto[]" value="<?php echo $datosDetalleCompra[$i]['Productos_IdProducto']?>" placeholder="Ingrese el id del Producto" required pattern="[0-9]+">
                    <div class="valid-feedback">
                        Formato Valido
                    </div>
                    <div class="invalid-feedback">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control needs-validation" id="Cantidad" name="Cantidad[]" value="<?php echo $datosDetalleCompra[$i]['Cantidad'] ?>" placeholder="Ingrese la cantidad" required pattern="[0-9]+">
                    <div class="valid-feedback">
                        Formato Valido
                    </div>
                    <div class="invalid-feedback">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control needs-validation" id="Precio" name="Precio[]" value="<?php echo $datosDetalleCompra[$i]['PrecioCompra'] ?>" placeholder="Ingrese el precio" required pattern="^[0-9]+([.][0-9]+)?$">
                    <div class="valid-feedback">
                        Formato Valido
                    </div>
                    <div class="invalid-feedback">
