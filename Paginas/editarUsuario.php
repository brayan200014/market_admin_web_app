...
<div class="p-5">
    ...
    <form class="g-3 needs-validation" action="" method="POST" novalidate>
        ...
        <div class="m-4 position-relative">
            ...
            <input type="text" class="form-control" id="nombre" name="nombre" value="<?php echo $datos[0]['NombreUsuario'] ?>" required>
        ...
        <div class="m-4 position-relative">
            ...
            <input type="email" class="form-control" id="descripcion" name="descripcion" value="<?php echo $datos[0]['Correo'] ?>" required>
            <!-- Mensajes para validación   -->
            <div class="valid-tooltip">¡Campo válido!</div>
            <div class="invalid-tooltip">Campo no valido.</div>
        </div>
        ...
        <div class="m-4 position-relative">
            ...
            <input type="text" class="form-control" id="idEmpleado" name="idEmpleado" value="<?php echo $datos[0]['Empleados_IdEmpleado'] ?>" required>
            <!-- Mensajes para validación   -->
            <div class="valid-tooltip"></div>
            <div class="invalid-tooltip">Campo no valido.</div>
        </div> 
